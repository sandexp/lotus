...
import com.ledis.analysis.{FunctionRegistry, TypeCheckResult, TypeCoercion}
import com.ledis.config.SQLConf
import com.ledis.expressions._
import com.ledis.expressions.aggregate.DeclarativeAggregate
...
import com.ledis.expressions.projection.Canonicalize
 ...
 *                              UDF/UDAF/UDTF.
 * - [[com.ledis.expressions.order.HigherOrderFunction]]: a common base trait for higher order functions that take one or more
 ...
 *                           [[com.ledis.plans.logical.LogicalPlan]].
 *
...
abstract class Expression extends TreeNode[Expression] {
   ...
   * executed. A typical use case: [[com.ledis.optimizer.ConstantFolding]]
   *
   * The following conditions are used to determine suitability for constant folding:
   *  - A [[Coalesce]] is foldable if all of its children are foldable
   *  - A [[BinaryExpression]] is foldable if its both left and right child are foldable
   *  - A [[com.ledis.expressions.predicate.Not]], [[IsNull]], or [[IsNotNull]] is foldable if its child is foldable
   *  - A [[com.ledis.expressions.projection.Literal]] is foldable
   *  - A [[com.ledis.expressions.projection.Cast]] or [[UnaryMinus]] is foldable if its child is foldable
   */
