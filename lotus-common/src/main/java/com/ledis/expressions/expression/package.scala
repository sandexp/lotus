 ...
 * expression, a [[com.ledis.expressions.expression.NamedExpression]] in addition to the standard collection of expressions.
 *
 * ==Standard Expressions==
 * A library of standard expressions (e.g., [[Add]], [[com.ledis.expressions.predicate.EqualTo]]), aggregates (e.g., SUM, COUNT),
 ...
 * The two types of named expressions are [[com.ledis.expressions.expression.AttributeReference]]s and [[com.ledis.expressions.expression.Alias]]es.
 * [[com.ledis.expressions.expression.AttributeReference]]s refer to attributes of the input tuple for a given operator and form
