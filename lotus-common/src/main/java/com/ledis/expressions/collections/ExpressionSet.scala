...
package com.ledis.expressions.collections
...
object ExpressionSet {
  /** Constructs a new [[ExpressionSet]] by applying [[com.ledis.expressions.projection.Canonicalize]] to `expressions`. */
 ...
 * See [[com.ledis.expressions.projection.Canonicalize]] for more details.
 *
...
class ExpressionSet protected(
  ...
  /**
   * Returns a string containing both the post [[com.ledis.expressions.projection.Canonicalize]] expressions and the original
