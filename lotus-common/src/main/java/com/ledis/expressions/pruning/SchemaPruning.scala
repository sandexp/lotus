package com.ledis.expressions.pruning

import com.ledis.expressions.expression._
import com.ledis.expressions.util.SelectedField
...
object SchemaPruning extends SQLConfHelper {
   ...
   * When expr is an [[com.ledis.expressions.expression.Attribute]], construct a field around it and indicate that that
