...
import com.ledis.types.AbstractDataType
 ...
 *
 * Most function expressions (e.g. [[com.ledis.expressions.expression.Substring]] should extend [[ImplicitCastInputTypes]]) instead.
 */
 ...
 * [[com.ledis.analysis.TypeCoercion.ImplicitTypeCasts]].
 */
