...
import com.ledis.expressions.expression.{Alias, Expression}
...
package object codegen {
  ...
  object ExpressionCanonicalizer extends com.ledis.rules.RuleExecutor[Expression] {
    val batches =
      Batch("CleanExpressions", FixedPoint(20), CleanExpressions) :: Nil

    object CleanExpressions extends com.ledis.rules.Rule[Expression] {
