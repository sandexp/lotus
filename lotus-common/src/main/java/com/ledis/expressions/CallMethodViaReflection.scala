...
import com.ledis.expressions.codegen.CodegenFallback
import com.ledis.expressions.expression.{Expression, Nondeterministic}
 ...
 * [[com.ledis.expressions.objects.StaticInvoke]] in the future.
 *
