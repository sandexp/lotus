...
import com.ledis.expressions.predicate.{Predicate, PredicateHelper}
import com.ledis.plans.QueryPlan
import com.ledis.plans.logical.{Filter, LogicalPlan}
...
object SubqueryExpression {
   ...
   * [[com.ledis.analysis.Analyzer.ResolveSubquery]]
   */
