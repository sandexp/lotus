...
import com.ledis.analysis.{Analyzer, GetColumnByOrdinal, SimpleAnalyzer, UnresolvedAttribute, UnresolvedExtractValue}
import com.ledis.codec.ExpressionEncoder.{Deserializer, Serializer}
...
import com.ledis.optimizer.{ReassignLambdaVariableID, SimplifyCasts}
import com.ledis.plans.logical.{CatalystSerde, DeserializeToObject, LeafNode, LocalRelation}
 ...
 * follows:
 *  - Classes will have their sub fields extracted by name using [[com.ledis.analysis.UnresolvedAttribute]] expressions
 *    and [[com.ledis.analysis.UnresolvedExtractValue]] expressions.
 *  - Tuples will have their subfields extracted by position using [[com.ledis.expressions.util.BoundReference]] expressions.
