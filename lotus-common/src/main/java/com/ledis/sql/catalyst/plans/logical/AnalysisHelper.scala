...
import com.ledis.sql.catalyst.expressions.{Attribute, Expression}
 ...
 * methods defined in [[com.ledis.sql.catalyst.trees.TreeNode]] and [[QueryPlan]].
 *
...
trait AnalysisHelper extends QueryPlan[LogicalPlan] { self: LogicalPlan =>
   ...
   * [[com.ledis.sql.catalyst.analysis.CheckAnalysis]].
   */
   ...
   * @see [[com.ledis.sql.catalyst.trees.TreeNode.transformDown()]].
   */
   ...
   * @see [[com.ledis.sql.catalyst.trees.TreeNode.transformUp()]]
   */
