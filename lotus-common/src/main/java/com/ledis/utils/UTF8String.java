...
import static com.ledis.utils.unsafe.Platform.*;

/**
 * A UTF-8 String for internal use.
 */
public final class UTF8String implements Comparable<UTF8String>, Externalizable, Serializable,
		Cloneable {
