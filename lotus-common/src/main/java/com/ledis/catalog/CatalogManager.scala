...
import com.ledis.catalog.extension.CatalogExtension
import com.ledis.catalog.support.SupportsNamespaces
import com.ledis.config.SQLConf
import com.ledis.exception.{CatalogNotFoundException, NoSuchNamespaceException}
...
class CatalogManager(
  ...
  import com.ledis.catalog.util.CatalogV2Util._
