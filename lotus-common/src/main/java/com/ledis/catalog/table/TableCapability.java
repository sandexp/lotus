...
import com.ledis.utils.writer.SupportsDynamicOverwrite;
import com.ledis.utils.writer.SupportsOverwrite;
import com.ledis.utils.writer.SupportsTruncate;
...
public enum TableCapability {
   ...
   * a write operation.
   * <p>
   * See {@link SupportsDynamicOverwrite}.
   */
  OVERWRITE_DYNAMIC,
