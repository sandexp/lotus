...
import com.ledis.expressions.expression.{Alias, Attribute}
import com.ledis.plans.logical.{LogicalPlan, Project, View}
 ...
 * [[com.ledis.plans.logical.CreateViewStatement]].
 */
