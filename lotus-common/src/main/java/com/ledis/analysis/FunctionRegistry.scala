...
import com.ledis.expressions.expression.{Acos, Acosh, AddMonths, Ascii, Asin, Asinh, Atan, Atan2, Atanh, BRound, Base64, Bin, BitLength, BitwiseAnd, BitwiseCount, BitwiseNot, BitwiseOr, BitwiseXor, CaseWhen, Cbrt, Ceil, Chr, Coalesce, ConcatWs, Conv, Cos, Cosh, Cot, CumeDist, CurrentDate, CurrentTimeZone, CurrentTimestamp, DateAdd, DateDiff, DateFormatClass, DateFromUnixDate, DatePart, DateSub, DayOfMonth, DayOfWeek, DayOfYear, Decode, DenseRank, Elt, Encode, EulerNumber, Exp, Expm1, Expression, Extract, Factorial, FindInSet, Floor, FormatNumber, FormatString, FromUTCTimestamp, FromUnixTime, Hex, Hour, Hypot, If, IfNull, InitCap, IsNaN, IsNotNull, IsNull, Lag, LastDay, Lead, Length, Levenshtein, Like, Log, Log10, Log1p, Log2, Logarithm, Lower, MakeDate, MakeInterval, MakeTimestamp, MicrosToTimestamp, MillisToTimestamp, Minute, Month, MonthsBetween, NTile, NaNvl, NextDay, Now, NthValue, NullIf, Nvl, Nvl2, OctetLength, Overlay, ParseToDate, ParseToTimestamp, ParseUrl, PercentRank, Pi, Pow, Quarter, RLike, Rand, Randn, Rank, RegExpExtract, RegExpExtractAll, RegExpReplace, Rint, Round, RowNumber, RuntimeReplaceable, Second, SecondsToTimestamp, Sentences, ShiftLeft, ShiftRight, ShiftRightUnsigned, Signum, Sin, Sinh, SoundEx, Sqrt, StringInstr, StringLPad, StringLocate, StringRPad, StringRepeat, StringReplace, StringSpace, StringSplit, StringTranslate, StringTrim, StringTrimLeft, StringTrimRight, Substring, SubstringIndex, Tan, Tanh, ToDegrees, ToRadians, ToUTCTimestamp, ToUnixTimestamp, TruncDate, TruncTimestamp, UnBase64, Unhex, UnixDate, UnixMicros, UnixMillis, UnixSeconds, UnixTimestamp, Upper, WeekDay, WeekOfYear, WidthBucket, Year}
import com.ledis.expressions.group.{Cube, Grouping, GroupingID, Rollup}
import com.ledis.expressions.hash._
import com.ledis.expressions.order._
import com.ledis.expressions.predicate._
import com.ledis.expressions.projection.Cast
import com.ledis.trees.TreeNodeTag
import com.ledis.types._
import com.ledis.utils.FunctionIdentifier
...
object FunctionRegistry {
  ...
  val expressions: Map[String, (ExpressionInfo, FunctionBuilder)] = Map(
    ...
    expression[com.ledis.expressions.expression.Left]("left"),
    expression[com.ledis.expressions.expression.Right]("right"),
    ...
    expression[PartitionID]("spark_partition_id"),
