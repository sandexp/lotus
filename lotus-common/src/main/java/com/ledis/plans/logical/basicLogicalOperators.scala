...
import com.ledis.expressions.order.{Ascending, Descending, SortOrder}
import com.ledis.expressions.predicate.{And, Or, PredicateHelper}
import com.ledis.expressions.projection.{IntegerLiteral, Literal}
import com.ledis.plans._
import com.ledis.plans.physical.{HashPartitioning, Partitioning, RangePartitioning, RoundRobinPartitioning}
 ...
 *                             [[com.ledis.expressions.aggregate.AggregateFunction]]s.
 *
 ...
 *                             For example, see the rule [[com.ledis.optimizer.SimplifyExtractValueOps]]
 */
 ...
 *   `com.ledis.execution.CollectTailExec` and
 *   `com.ledis.execution.CollectLimitExec`
 *
...
case class OneRowRelation() extends LeafNode {
  ...
  /** [[com.ledis.trees.TreeNode.makeCopy()]] does not support 0-arg ctor. */
