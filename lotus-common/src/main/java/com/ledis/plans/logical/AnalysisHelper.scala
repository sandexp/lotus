 ...
 * methods defined in [[com.ledis.trees.TreeNode]] and [[QueryPlan]].
 *
...
trait AnalysisHelper extends QueryPlan[LogicalPlan] { self: LogicalPlan =>
   ...
   * [[com.ledis.analysis.CheckAnalysis]].
   */
  ...
  protected def assertNotAnalysisRule(): Unit = {
    if (AnalysisHelper.inAnalyzer.get > 0 &&
   ...
   * @see [[com.ledis.trees.TreeNode.transformDown()]].
   */
   ...
   * @see [[com.ledis.trees.TreeNode.transformUp()]]
   */
