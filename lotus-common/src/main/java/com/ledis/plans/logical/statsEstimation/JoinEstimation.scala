...
package com.ledis.plans.logical.statsEstimation

import com.ledis.expressions.expression.{Attribute, AttributeReference, Expression}

import scala.collection.mutable
import scala.collection.mutable.ArrayBuffer
import com.ledis.planning.ExtractEquiJoinKeys
import com.ledis.plans._
import com.ledis.plans.logical.{ColumnStat, Histogram, Join, Statistics}
import com.ledis.plans.logical.statsEstimation.EstimationUtils._
import com.ledis.utils.collections.AttributeMap


case class JoinEstimation(join: Join) {
